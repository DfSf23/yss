...
<div class="parallax">
    ...
    <?php
        include_once 'tr.php';
    ?>
   <h1> <a>Your proffile </a></h1>
        <?php
            if(isset($_SESSION["useruid"])){
                echo "<p>Hi ". $_SESSION["useruid"]."</p>". "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
...
Vestibulum pretium pellentesque tellus, in bibendum massa blandit a.</p>";
                ...
                echo "<p>Log in to see your account information.<br>If you don't have an account yet, you can create one.</p>";
            }
        ?>
